 const faqs = [
    {
      ...
      answer:
        " The best (and quickest) way to get help on a challenge is in our Discord server.There are thousands of other developers in there,so it's a great place to ask questions. We even have a dedicate help channel! If you haven't joined yet, you can get an invite to our Discord server here.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Frontend Mentor is a collaborative learning community where everyone can give feedback to each other. If you'd like to receive feedback from the community, please be sure to post a question when you submit your solution. ",
    },
    {
